...
public class PuzzleHouseComponentThanks extends JComponent
{
    public void paintComponent(Graphics g) {
     ...
     g2.setColor(black);
     g2.drawString("Or is it?", 10, 20);
     g2.drawString("Thanks for Playing ;)", 10, 60);
     
     Ellipse2D.Double face = new Ellipse2D.Double(140, 180, 30, 30);
     g2.draw(face);
     g2.setColor(black);
     g2.fill(face);
     
     Ellipse2D.Double left = new Ellipse2D.Double(150, 190, 5, 5);
     g2.draw(left);
     g2.setColor(white);
     g2.fill(left);
     
     Ellipse2D.Double right = new Ellipse2D.Double(160, 190, 5, 5);
     g2.draw(right);
     g2.setColor(white);
     g2.fill(right);
